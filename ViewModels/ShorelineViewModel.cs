...
public partial class ShorelineViewModel : BaseViewModel
{
    public ShorelineViewModel()
    {
        ...
        allQuests = [.. qservice.GetShorelineQuests().OrderBy(q => q.Name)];
    }

    [RelayCommand]
    public override void RedrawMap()
    {
        Map = new MapDrawable("map_shoreline.png", 
            AllExtracts, AllSpawns, SelectedQuests, 
            SelectedSpawn, ShowGrids, ShowQuests, 
            ShowExtracts, ShowGuides, ShowSpawns);       
    }
}
